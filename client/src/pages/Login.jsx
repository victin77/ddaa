...
import { ShieldCheck, UserRound, Sparkles, ArrowRight, Eye, EyeOff } from 'lucide-react';
          ...
          <div className="p-7">
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-2xl bg-white/10 border border-white/10 px-4 py-3 pr-12 text-white placeholder:text-white/50 focus:outline-none focus:ring-2 focus:ring-blue-400/60"
                    placeholder="********"
                  ...
                  <button
                    ...
                    className="absolute inset-y-0 right-0 inline-flex items-center justify-center px-4 text-white/60 hover:text-white"
              ...
              <div className="text-xs text-white/60 leading-relaxed">
                <div className="font-semibold text-white/70 mb-1">Acesso</div>
                <div>Administrador: use as credenciais configuradas no ambiente.</div>
                <div className="mt-2">Consultores: use o usuario e a senha definidos em <span className="font-mono">Configuracoes</span>.</div>
              </div>
            </form>
          </div>
        </div>
