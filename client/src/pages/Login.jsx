          ...
          <div className="p-7">
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <div className="text-xs text-white/60 leading-relaxed">
                ...
                <div className="mt-2">Consultores (login automático): usuário é o <span className="font-semibold">nome em minúsculo</span> (ex.: <span className="font-mono text-white">gustavo</span>) e a senha padrão é <span className="font-mono text-white">consultor</span> (mude no Render com <span className="font-mono">CONSULTANT_DEFAULT_PASSWORD</span>).</div>
              </div>
            </form>
          </div>
        </div>
