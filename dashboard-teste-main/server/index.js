...
app.post('/api/sales', auth(), async (req, res) => {
  ...
  const base_value = Number(body.base_value);
  ...
  res.json({ ...created, insurance: !!created.insurance, installments: its });
});
...
app.put('/api/sales/:id', auth(), async (req, res) => {
  ...
  const body = req.body || {};
  const base_value = body.base_value !== undefined ? Number(body.base_value) : existing.base_value;
  ...
  await db.run(
    ...
    [
      ...
      base_value,
      body.quotas !== undefined ? Number(body.quotas) : existing.quotas,
      body.unit_value !== undefined ? Number(body.unit_value) : existing.unit_value,
      commission_percentage,
      total_commission,
  ...
  res.json({ ...updated, insurance: !!updated.insurance, installments: its });
});
